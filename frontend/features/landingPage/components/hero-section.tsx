        ...
        <div className="flex flex-col justify-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-lg text-muted-foreground text-pretty md:text-xl">
              Jednoduchá elektronická evidencia jázd podľa § 85n zákona o DPH. Chráni podnikateľa, stráži povinnosti,
          ...
          <div className="flex flex-col items-start gap-3 rounded-lg border bg-muted/50 p-4">
            ...
            <p className="text-sm text-muted-foreground">My uložíme fotku, prečítame stav a doplníme jazdu za vás.</p>
          </div>
          ...
          <div className="rounded-2xl border bg-card p-8 shadow-2xl">
            <div className="space-y-6">
              ...
              <div className="rounded-lg border bg-background p-4">
                ...
                <img src="/electronic-driving-logbook-dashboard-with-trip-ent.jpg" alt="Dashboard knihy jázd" className="w-full rounded" />
              </div>

              {/* Mobile mockup */}
              <div className="flex justify-center">
                <div className="w-48 rounded-3xl border-4 border-foreground/20 bg-background p-2">
                  <img src="/mobile-app-odometer-photo-capture-screen.jpg" alt="Mobilná aplikácia" className="w-full rounded-2xl" />
                </div>
              </div>
            </div>
          </div>
