                ...
                <div className="mx-auto max-w-5xl space-y-12">
                    <div className="space-y-4 text-center">
                        ...
                        <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                            Každý platící zákazník má v aplikácii svoju sekciu &ldquo;Affiliate&rdquo;, kde nájde osobný
                            odkaz. Stačí ho poslať
                            kolegovi, známemu podnikateľovi alebo klientovi – a za každého nového platiaceho používateľa
                            získavate
                            odmenu.
                        </p>
                    </div>
                    ...
                    <div className="grid gap-6 md:grid-cols-3">
                        ...
                        <Card className="p-6">
                            ...
                            <p className="text-sm text-muted-foreground mb-3">Za každého platiaceho klienta
                                získavate:</p>
                    ...
                    <div className="text-center">
                        <Button size="lg" variant="outline" asChild>
                            <Link href={'/client-affiliate'}>Viac o affiliate programe
                            </Link>
                        </Button>
                    </div>
                </div>
